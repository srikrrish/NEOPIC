...
configs = {
    ...
    'device':               torch.device('cpu'),       # Define device for training & inference - GPU/CPU
...
def train (configs):
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f"_Models/1layer_1_neuron/loss_history.png")
    plt.close()
    ...
    if configs['save_model']:
        ...
        torch.save(best_model, f"_Models/1layer_1_neuron/{configs['experiment']}_{configs['model']}.pt")
